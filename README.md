...
- `26.7.2` — волны приближения монстров и переключатель их отображения;
- `26.8.0 beta` — Tick нельзя поднять; волны playerClose замедлены вдвое; обводка иконок и волн стала толще и масштабируется вместе с иконками.
