...
Сбор расширенной статистики и файл `stats/levels.jsonl` в текущей версии отключены.
...
### Исследованные проекты и инструменты тестирования

Эти моды **не являются зависимостями OverlayHUD**:

- [TimerMod by Bydlo](https://thunderstore.io/c/repo/p/Bydlo/TimerMod/) — изучался как референс жизненного цикла уровня и отображения респавна врагов. Текущая реализация OverlayHUD не обращается к TimerMod во время игры.
- [Imperium Repo](https://thunderstore.io/c/repo/p/giosuel/Imperium_Repo/) — использовался как инструмент тестирования уровней, врагов и игровых событий.
- [ChaosTricks R.E.P.O. integration](https://chaostricks.com/configure/REPO/) — использовалась для проверки нестандартных и созданных модами врагов.
- [MenuLib](https://thunderstore.io/c/repo/p/nickklmao/MenuLib/) — рассматривался для внутриигрового UI, но не используется текущим HTML/Electron HUD.
...
Исходный код OverlayHUD распространяется по лицензии [Mozilla Public License 2.0](LICENSE). При распространении изменённых файлов их исходный код должен оставаться доступным на условиях MPL-2.0; MPL при этом допускает сочетание OverlayHUD с кодом под другими лицензиями.

Шрифты, зависимости, игровые изображения, торговые марки и другие сторонние материалы не перелицензируются под MPL-2.0. Их условия и сведения об авторстве перечислены в [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md) и соответствующих license-файлах.
