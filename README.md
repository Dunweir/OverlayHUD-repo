...
Отдельная лицензия проекта пока не добавлена. До появления `LICENSE` стандартное авторское право сохраняется за EgorSalad; публичное размещение исходников само по себе не даёт разрешения на их копирование, изменение или повторное распространение.
